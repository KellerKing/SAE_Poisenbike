...
CREATE TABLE IF NOT EXISTS `fahrer` (
  ...
  CONSTRAINT `FK_fahrer_team` FOREIGN KEY (`TeamID`) REFERENCES `team` (`TeamID`)
...
CREATE TABLE IF NOT EXISTS `wettkampf` (
  ...
  CONSTRAINT `FK_wettkampf_strecke` FOREIGN KEY (`StreckenID`) REFERENCES `strecke` (`StreckenID`)
